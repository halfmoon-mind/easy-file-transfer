...
const privateKey = fs.readFileSync(
  '/home/ec2-user/easy-file-transfer/privkey.pem',
  'utf8',
);
const certificate = fs.readFileSync(
  '/home/ec2-user/easy-file-transfer/fullchain.pem',
  'utf8',
);
...
io.on('connection', (socket) => {
  ...
  socket.on('requestFile', (data) => {
    ...
    io.to(users[uploaderId]).emit('requestFile', {
      fileName,
      requesterId,
      uploaderId,
    });
    console.log(
      `File request: ${fileName} from ${requesterId} to ${uploaderId}`,
    );
  });
